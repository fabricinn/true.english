"*Seem*" e "*like*" são duas palavras em inglês que frequentemente são usadas para expressar opiniões, percepções e simpatias. No entanto, elas são usadas de maneiras um pouco diferentes:
